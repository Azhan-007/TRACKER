                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <div className="flex justify-center gap-2">
                       <button className="p-2 rounded-lg bg-white/5 hover:bg-white/10 hover:text-purple-400 transition-all">
                         <ExternalLink className="w-4 h-4" />
                       </button>
                       <button className="p-2 rounded-lg bg-white/5 hover:bg-white/10 hover:text-blue-400 transition-all">
                         ...
                         <div className="grid grid-cols-2 gap-8">
                           ...
                           <div className="space-y-6">
                             ...
                             <div className="flex gap-3 pt-2">
                                <button className="flex-1 py-2 rounded-lg bg-green-500/10 text-green-400 border border-green-500/20 text-[10px] uppercase font-mono font-bold tracking-widest hover:bg-green-500/20 transition-all">
                                  Approve Module
                                </button>
                                <button className="flex-1 py-2 rounded-lg bg-white/5 text-white/40 border border-white/10 text-[10px] uppercase font-mono font-bold tracking-widest hover:bg-white/10 transition-all">
                                  Request Audit
                                </button>
                             </div>
                           </div>
